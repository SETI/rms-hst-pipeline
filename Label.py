...
class Label:
    ...
    __schematronHrefs = ['https://pds.nasa.gov/pds4/pds/v1/PDS4_PDS_1500.sch',
			 ...
			 'https://pds.nasa.gov/pds4/schema/develop/mission/insight/PDS4_INSIGHT_1000.sch',
			 'https://pds.nasa.gov/pds4/schema/develop/mission/insight/PDS4_INSIGHT_CAMERAS_RAW_1500.sch']

    def __writePIs(self):
	d = self.document
	for href in Label.__schematronHrefs:
	    data = 'href="%s" schematypens="http://purl.oclc.org/dsdl/schematron"' % href
...
class TestLabel(unittest.TestCase):
    def testInit(self):
        minimalLabel = Label()
        minimalXml = '<?xml version="1.0" encoding="utf-8"?><?xml-model href="https://pds.nasa.gov/pds4/pds/v1/PDS4_PDS_1500.sch" schematypens="http://purl.oclc.org/dsdl/schematron"?><?xml-model href="https://pds.nasa.gov/pds4/schema/develop/img/PDS4_IMG_1500.sch" schematypens="http://purl.oclc.org/dsdl/schematron"?><?xml-model href="https://pds.nasa.gov/pds4/schema/develop/geom/PDS4_GEOM_1500.sch" schematypens="http://purl.oclc.org/dsdl/schematron"?><?xml-model href="https://pds.nasa.gov/pds4/schema/develop/mission/insight/PDS4_INSIGHT_1000.sch" schematypens="http://purl.oclc.org/dsdl/schematron"?><?xml-model href="https://pds.nasa.gov/pds4/schema/develop/mission/insight/PDS4_INSIGHT_CAMERAS_RAW_1500.sch" schematypens="http://purl.oclc.org/dsdl/schematron"?><Product_Observational/>'
