...
def _get_subarray_flag(card_dicts, instrument, product_id):
    # type: (_CARDS, unicode, unicode) -> unicode
    """
...
)  # type: Callable[[_CARDS, unicode, unicode], unicode]
"""
...
def _get_aperture_name(card_dicts, shm_card_dicts, instrument, product_id):
    # type: (_CARDS, _CARDS, unicode, unicode) -> unicode
    if instrument == 'wfpc2':
        try:
...
def _get_aperture_name_placeholder(card_dicts, shm_card_dicts, instrument, product_id):
    # type: (_CARDS, _CARDS, unicode, unicode) -> unicode
...
)  # type: Callable[[_CARDS, _CARDS, unicode, unicode], unicode]
"""
...
)  # type: Callable[[_CARDS, str, str], unicode]
"""
...
def get_hst_parameters(card_dicts, shm_card_dicts, instrument, product_id):
    ...
    d = {'stsci_group_id': get_stsci_group_id(card_dicts, product_id),
         ...
         'aperture_name': get_aperture_name(card_dicts, shm_card_dicts,
                                            instrument,
                                            product_id),
