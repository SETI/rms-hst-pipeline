...
MINOR_PLANET_TYPES = ('Asteroid', 'Centaur', 'Trans-Neptunian Object',
                      'Dwarf Planet')
...
def minor_planet_identifications(keys, a=0., e=0., i=0., q=0.,
    ...
    for key in keys:
        ...
        if minor_planet_identifications.IGNORE_EXTRA_NAMES:
            warnings.append('WARNING: Malformed minor planet identifier, ' +
                            f'ignored: {key}')
            if minor_planet_identifications.DEBUG:
    ...
    for key in keys:
        ...
        if not info:
            if minor_planet_identifications.IGNORE_EXTRA_NAMES:
                warnings.append('WARNING: Unrecognized MPC identifier, ' +
                                f'ignored: {key}')
                if minor_planet_identifications.DEBUG:
