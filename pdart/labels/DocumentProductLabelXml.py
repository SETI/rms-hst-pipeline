...
# ----------------
def _make_proposal_description(proposal_id, proposal_title, pi_name, publication_year):
        ...
        return _citation_information_template(
            {
                ...
                "description": _make_proposal_description(
                    proposal_id, proposal_title, pi_name, proposal_year
                ),
            }
        )
...
_make_file = interpret_template(
    '<file_name><NODE name="file_name" />\
</file_name>'
)  # type: NodeBuilderTemplate

_make_document_standard_id = interpret_template(
