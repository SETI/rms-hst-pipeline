...
class Test_Utils(unittest.TestCase):
    def test_wavelength_from_range(self) -> None:
        ...
        self.assertEqual(
            ["Near Infrared", "Infrared"], wavelength_from_range((0.75, 300))
        )
        self.assertEqual(
            ["Ultraviolet", "Visible"], wavelength_from_range((0.395, 0.6))
        )
        self.assertEqual(
        ...
        self.assertEqual(["Infrared"], wavelength_from_range((6, 100)))
