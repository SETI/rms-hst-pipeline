...
class Citation_Information:
    ...
    The returned Citation_Information object has the following properties,
    which return attributes appropriate to the PDS4 Citation_Information object.
        author_list
        editor_list
        publication_year
    ...
    determined from the .apt or .pro files. This routine implements a number of
    work-arounds to provide this information:

    1. Call method set_publication_year to set the correct year. This is the
       preferred method but requires an external procedure to determine the
       year.
