...
from pdart.fs.DirUtils import dir_to_lid, dir_to_lidvid, lid_to_dir, lidvid_to_dir
...
class Test_DirUtils(unittest.TestCase):
    ...
    def test_lidvid_to_dir(self):
        # type: () -> None
        self.assertEqual(u"/b/v$1.5", lidvid_to_dir(LIDVID("urn:nasa:pds:b::1.5")))
        self.assertEqual(u"/b/c/v$2.5", lidvid_to_dir(LIDVID("urn:nasa:pds:b:c::2.5")))
        self.assertEqual(
            u"/b/c/p/v$333.123", lidvid_to_dir(LIDVID("urn:nasa:pds:b:c:p::333.123"))
        )
    ...
    def test_dir_to_lidvid(self):
        ...
        with self.assertRaises(Exception):
            dir_to_lidvid(u"/b")
        self.assertEqual(LIDVID("urn:nasa:pds:b::1.5"), dir_to_lidvid(u"/b/v$1.5"))
        self.assertEqual(LIDVID("urn:nasa:pds:b:c::2.6"), dir_to_lidvid(u"/b/c/v$2.6"))
        self.assertEqual(
            LIDVID("urn:nasa:pds:b:c:p::333.321"), dir_to_lidvid(u"/b/c/p/v$333.321")
        )
