...
def build_labels(bundle_segment,
                 working_dir,
                 archive_dir,
    ...
    with make_osfs(archive_dir) as archive_osfs, \
            ...
            make_sv_deltas(browse_deltas, archive_label_deltas_dir) as label_deltas:
        ...
        info = _placeholder_citation_information(str(bundle_lidvid))
