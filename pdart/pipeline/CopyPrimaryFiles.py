...
def _copy_docs_files(bundle_segment, documents_dir, primary_files_dir):
...
def _copy_fits_files(bundle_segment, mast_downloads_dir, primary_files_dir):
    # type: (unicode, unicode, unicode) -> None
...
def copy_primary_files(
    bundle_segment, documents_dir, mast_downloads_dir, primary_files_dir
):
