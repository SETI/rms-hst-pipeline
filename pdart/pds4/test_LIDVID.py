...
def pdart_lidvid_strings():
    ...
    two components.
    """
    return st.builds(lambda lid, vid: '%s::%s' % (lid, vid),
                     lid_strings(),
                     pdart_vid_strings())
...
class TestLIDVID(unittest.TestCase):
    ...
    def test_lidvid_lid_vid_properties(self, lid, vid):
        self.assertEqual
    ...
    @given(pdart_lidvids())
    def test_is_bundle_lidvid_property(self, lidvid):
        self.assertEqual(lidvid.is_bundle_lidvid(),
                         lidvid.lid().is_bundle_lid())
    ...
    @given(pdart_lidvids())
    def test_is_collection_lidvid_property(self, lidvid):
    ...
    @given(pdart_lidvids())
    def test_is_product_lidvid_property(self, lidvid):
    ...
    @given(pdart_lidvids())
    def test_is_next_major_lidvid_property(self, lidvid):
        self.assertEqual(
            LIDVID.create_from_lid_and_vid(lidvid.lid(),
                                           lidvid.vid().next_major_vid()),
    ...
    @given(pdart_lidvids())
    def test_is_next_minor_lidvid_property(self, lidvid):
        self.assertEqual(
            LIDVID.create_from_lid_and_vid(lidvid.lid(),
    ...
    def test_str_roundtrip_property(self, lidvid_str):
        ...
        '''
        self.assertEquals(lidvid_str, str(LIDVID(lidvid_str)))
