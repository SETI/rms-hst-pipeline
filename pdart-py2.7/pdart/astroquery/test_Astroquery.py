...
class TestAstroquery(unittest.TestCase):
    ...
    def test_observation_column_names(self):
        ...
        expected = [
            'calib_level', 'dataRights', 'dataURL', 'dataproduct_type',
            'em_max', 'em_min', 'filters', 'instrument_name', 'intentType',
            'jpegURL', 'mtFlag', 'objID', 'obs_collection', 'obs_id',
            'obs_title', 'obsid', 'project', 'proposal_id', 'proposal_pi',
            'proposal_type', 'provenance_name', 's_dec', 's_ra', 's_region',
            'sequence_number', 'srcDen', 't_exptime', 't_max', 't_min',
    ...
    def test_product_column_names(self):
        ...
        expected = [
            'dataRights', 'dataURI', 'dataproduct_type', 'description',
            'obsID', 'obs_collection', 'obs_id', 'parent_obsid',
            'productDocumentationURL', 'productFilename',
