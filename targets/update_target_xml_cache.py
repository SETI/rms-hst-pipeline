...
TARGET_CACHE = pathlib.Path(os.path.dirname(__file__)) / 'TARGET_CACHE'
...
PARSER = argparse.ArgumentParser(
    ...
    epilog = 'NOTE: to add or update a context product locally, create a properly named '
             ...
             'suffix, appears at the Engineering Node.')
...
# MPNAME: Matches a name including diacritics, apostrophes and internal dashes; no
