...
.PHONY: test
test: venv
	$(ACTIVATE) && PYTHONPATH=$(PDSTOOLS_WEBTOOLS_PATH) pytest pdart

# Run some subset of the tests.  Hack as needed.
.PHONY: t
t: venv
	$(ACTIVATE) && PYTHONPATH=$(PDSTOOLS_WEBTOOLS_PATH) pytest pdart/fs/cowfs/test_COWFS.py
...
# LILS=7240
# v COS/NUV: [12607, 13492, 13328, 13874, 11536, 12312, 13197]
# v STIS/NUV-MAMA: [8218]
# v STIS/CCD: [15095, 7315, 7583, 7240, 8578, 7939, 7316, 8117, 9112, 14612, 13336, 15249, 13197, 13694, 9185, 15490, 8258, 8224, 7312, 14609, 12244, 9056, 12607, 13040, 12312, 9906, 7582, 15111, 13492, 6854, 7717, 8158, 14931, 13874, 12478, 13619, 8276, 15122, 7314, 7769, 12041, 8231, 10341, 13736, 7605, 8108, 14257, 8218, 13488, 9296, 13805, 15167, 13693, 9119, 9496, 16770, 9985, 14903, 7313, 9062, 13328, 15379, 16499]
# v WFPC2/PC: [7240, 6842, 5829, 9725, 6315, 9268, 9585, 7792, 5653, 8876, 10357, 11518, 5238, 7717, 5624, 10065, 8871, 7916, 9320, 11418, 6591, 6846, 11497, 8405, 10770, 5167, 7594, 6029, 9259, 5590, 6853, 5392, 6216, 6803, 5824, 5216, 6621]
